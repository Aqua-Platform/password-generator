...
class password_generator {
	...
	*/
	...
	public function password_print( $var ) { 
	...
	*/
	...
	private function password_parse_args( $args = array(), $defaults = array() ) { 
	...
	*/
	...
	private function set_args( $args = array() ) { 
		...
		$args = $this->password_parse_args( $args, $defaults );
		$this->args = $args;	 
	}
